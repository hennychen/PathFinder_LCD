...
### 2.1 OV2640 摄像头 — DVP 并行接口（14 GPIO）

使用 LCD_CAM 外设控制器，标准 ESP-IDF DVP 引脚配置。
...
| D3 | 10 | PCLK | 13 |
| D4 | 12 | XCLK | 15 |
| D5 | 18 | SIOD (SCCB SDA) | 4 |
| D6 | 17 | SIOC (SCCB SCL) | 5 |

### 2.2 AcousticEye 模块 — ES7210 + WS2812（7 GPIO）

I2C1 控制器配置 ES7210 寄存器，I2S0 控制器传输音频流，RMT 驱动 WS2812 灯环。
...
### 2.4 xiaozhi AI TTS 输出 — I2S1（3 GPIO）

| 信号 | GPIO |
|------|------|
| I2S1 BCLK | 1 |
| I2S1 WS | 2 |
| I2S1 DOUT → MAX98357A | 3 |
...
- 剩余备用：0, 22, 23, 24, 25, 35, 36, 37, 45, 46
