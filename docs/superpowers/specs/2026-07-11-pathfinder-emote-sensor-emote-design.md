...
| 序号 | 名称 | 含义 | | 序号 | 名称 | 含义 |
|------|------|------|---|------|------|------|
| 0 | angry_20s | 生气 | | 12 | panic_05s_15 | 恐慌 |
| 1 | asleep_215s | 睡着 | | 13 | ponder_05s | 沉思 |
| 2 | badminton_12 | 打羽毛球 | | 14 | question_05s | 疑问 |
| 3 | confident_08 | 自信 | | 15 | sad_05s15s | 悲伤 |
| 4 | cry_10s_20s | 哭泣 | | 16 | shocked_05s_ | 震惊 |
| 5 | investigate_ | 调查/专注 | | 17 | shy_20s_40s | 害羞 |
| 6 | laugh_05s_10 | 大笑 | | 18 | sigh_20s_40s | 叹气 |
| 7 | leisure_05s_ | 休闲 | | 19 | smile_05s | 微笑 |
| 8 | mock_05s | 嘲讽 | | 20 | smile_static | 微笑(静) |
| 9 | music_25s | 听音乐 | | 21 | snigger_10s | 窃笑 |
...
2. 若找不到，尝试模糊匹配（如 "surprised" → "surprise" / "shock"）
3. 若仍找不到，回退到序号轮播模式
