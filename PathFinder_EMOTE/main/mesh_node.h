...
/**
 * @brief Start mesh ROOT node after WiFi is already initialized
 *        (e.g., after wifi_config_manager provisioned and connected).
 *        Skips WiFi/netif init, only does mesh-specific init.
 *        Uses provided router credentials for the mesh config.
