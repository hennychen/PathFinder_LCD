...
ESP32-S3                   传感器组
┌──────────┐              ┌──────────────────────────┐
│  GPIO 12 ├──── SCL ────►│ AHT20 (0x38)  SCL       │
│          │              │ BMP280 (0x76) SCL       │
│          │              │ MPU6050 (0x68) SCL      │
│  GPIO 14 ├──── SDA ────►│ AHT20 (0x38)  SDA       │
│          │              │ BMP280 (0x76) SDA       │
│          │              │ MPU6050 (0x68) SDA      │
...
| 模块 | 文件 | 功能 |
|------|------|------|
| 传感器驱动 | `drivers/drv_aht20.c/h`、`drv_bmp280.c/h`、`drv_mpu9250.c/h`、`drv_uv_adc.c/h` | AHT20 温湿度、BMP280 气压海拔、MPU6050/9250 IMU、GUVA-S12SD UV |
| 传感器管理 | `sensor_manager.c/h` | 双任务采样（env 1Hz + imu 25Hz），I2C-1 总线（GPIO12/14，400kHz） |
